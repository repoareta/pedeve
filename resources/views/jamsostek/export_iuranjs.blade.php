                    ...
                    <td>
                        <table width="100%" style="font-size: 10pt;border-collapse: collapse;" border="1">
                            ...
                            <tr >
                                ...
                                <td style="text-align:right;">{{number_format(round($data->gapok,0)/(2.35*(2/100))*-1,0)}}</td>
                                <td style="text-align:right;">{{$data->status == 'B' ? number_format((round($data->gapok,0)/(2.35*(2/100))*-1)*(0.008)*(2.35),0) : number_format((0.008)*(round($data->gapok,0)/(2.35*(2/100))*-1),0)}}</td>
                                <td style="text-align:right;">{{$data->status == 'B' ? number_format((round($data->gapok,0)/(2.35*(2/100))*-1)*(0.037)*2.35,0) : number_format((0.037)*(round($data->gapok,0)/(2.35*(2/100))*-1),0)}}</td>
                                <td style="text-align:right;">{{$data->status == 'B' ? number_format((round($data->gapok,0)/(2.35*(2/100))*-1)*(0.02)*2.35,0) : number_format((0.02)*(round($data->gapok,0)/(2.35*(2/100))*-1),0)}}</td>
                                <td style="text-align:right;">{{$data->status == 'B' ? number_format((round($data->gapok,0)/(2.35*(2/100))*-1)*(0.003)*2.35,0) : number_format((0.003)*(round($data->gapok,0)/(2.35*(2/100))*-1),0)}}</td>
                            <?php

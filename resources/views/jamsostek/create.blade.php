				...
				<div class="kt-portlet__body">
					<div class="form-group form-group-last">
						...
						<div class="form-group row">
							...
							<div class="col-10">
								<input class="form-control" name="accident" type="text" value="" size="20" maxlength="20"  required oninvalid="this.setCustomValidity('Accident Harus Diisi..')" oninput="this.value = this.value.replace(/[^0-9\-]+/g, ',');setCustomValidity('')" >
							</div>
						</div>
						<div class="form-group row">
							<label class="col-2 col-form-label">Pensiun<span style="color:red;">*</span></label>
							<div class="col-10">
								<input class="form-control" name="pensiun" type="text" value="" size="20" maxlength="20"  required oninvalid="this.setCustomValidity('Pensiun Harus Diisi..')" oninput="this.value = this.value.replace(/[^0-9\-]+/g, ',');setCustomValidity('')" >
							</div>
						</div>
						<div class="form-group row">
							<label class="col-2 col-form-label">Life<span style="color:red;">*</span></label>
							<div class="col-10">
								<input class="form-control" name="life" type="text" value="" size="20" maxlength="20"  required oninvalid="this.setCustomValidity('Life Harus Diisi..')" oninput="this.value = this.value.replace(/[^0-9\-]+/g, ',');setCustomValidity('')" >
							</div>
						</div>
						<div class="form-group row">
							<label class="col-2 col-form-label">Manulife<span style="color:red;">*</span></label>
							<div class="col-10">
								<input class="form-control" name="manulife" type="text" value="" size="20" maxlength="20"  required oninvalid="this.setCustomValidity('Manulife Harus Diisi..')" oninput="this.value = this.value.replace(/[^0-9\-]+/g, ',');setCustomValidity('')" >
							</div>
						</div>

		...
		<div class="kt-subheader__main">
			...
			<div class="kt-subheader__breadcrumbs">
				...
				<a href="" class="kt-subheader__breadcrumbs-link">
					Posting Kas Bank </a>
				<span class="kt-subheader__breadcrumbs-separator"></span>
				<span class="kt-subheader__breadcrumbs-link kt-subheader__breadcrumbs-link--active">Batal</span>
			</div>
		</div>
	</div>
</div>
						...
						<div class="alert alert-secondary" role="alert">
							<div class="alert-text">
								<h5 class="kt-portlet__head-title">
									Header Batalkan Posting Kas Bank
								</h5>	
							</div>
						</div>
...
@section('scripts')
	...
	$(document).ready(function () {
		...
		$('#form-create').submit(function(){
			var nokas = $("#nokas").val();
			$.ajax({
				url  : "{{route('postingan_kas_bank.store.btlposting')}}",
				type : "POST",
				...
				success : function(data){
					...
					if(data == 1){
						Swal.fire({
							type  : 'success',
							title : 'Pembatalan posting kas bank '+nokas+' selesai',
							text  : 'Berhasil',
						}).then(function() {
						...
						Swal.fire({
							type  : 'info',
							title : 'Pembatalan posting gagal,hanya untuk tanggal transaksi di bulan buku aktif.',
							text  : 'Failed',
						});
					}else{
						Swal.fire({
							type  : 'info',
							title : 'Tidak ada data yang akan di batalkan pada range tanggal diatas.',
							text  : 'Failed',
						});
					}
				}, 

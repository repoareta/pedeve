		...
		<div class="kt-subheader__main">
			...
			<div class="kt-subheader__breadcrumbs">
				...
				<a href="" class="kt-subheader__breadcrumbs-link">
					Kontroler </a>
				<span class="kt-subheader__breadcrumbs-separator"></span>
				<span class="kt-subheader__breadcrumbs-link kt-subheader__breadcrumbs-link--active">Cetak Kas Bank</span>
			</div>
		</div>
	</div>
</div>
...
<div class="kt-portlet kt-portlet--mobile">
	...
	<div class="kt-portlet__body">
		<form class="kt-form kt-form--label-right" action="{{route('cetak_kas_bank.export')}}" method="post">
			{{csrf_field()}}
			<div class="kt-portlet__body">
				<div class="form-group row">
					<label class="col-2 col-form-label">Tanggal Cetak</label>
					<div class="col-8">
						<input size="30" maxlength="30"  class="form-control" type="text" value="{{date('d-m-Y')}}" name="tanggal" id="tanggal">
					</div>
				</div>
			@if($mp == "P")
				<div class="form-group row">
			...
			@else
				...
				<div class="kt-form__actions">
					<div class="row">
						<div class="col-2"></div>
						<div class="col-10">
							<a  href="{{route('cetak_kas_bank.index')}}" class="btn btn-warning"><i class="fa fa-reply" aria-hidden="true"></i>Cancel</a>

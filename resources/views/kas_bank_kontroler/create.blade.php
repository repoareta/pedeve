				...
				<div class="kt-portlet__body">
					<div class="form-group form-group-last">
						...
						<div class="form-group row">
							...
							<div class="col-10">
								<input class="form-control" type="text" value="" name="kode" size="2" maxlength="2" title="Kode" onkeyup="this.value = this.value.toUpperCase()" autocomplete='off' required oninvalid="this.setCustomValidity('Kode Harus Diisi...')" oninput="setCustomValidity('')">
							</div>
						</div>
						<div class="form-group row">
						...
						<div class="form-group row">
							...
							<div class="col-10">
								<select name="sanper" class="form-control selectpicker" data-live-search="true" required oninvalid="this.setCustomValidity('Debet Dari Harus Diisi..')" onchange="setCustomValidity('')">
									...
									<option value="{{$data->kodeacct}}">{{$data->kodeacct}} -- {{$data->descacct}}</option>
									@endforeach
								</select>
						...
						<div class="form-group row">
							...
							<div class="col-10">
								<input class="form-control" type="text" value="" name="norek"  size="20" maxlength="20" title="No. rekening"  onkeypress="return hanyaAngka(event)" autocomplete='off' required oninvalid="this.setCustomValidity('No. Rekening Harus Diisi...')" oninput="setCustomValidity('')">
							</div>
						</div>
						<div class="form-group row">
...
@section('scripts')
	...
	$(document).ready(function () {
		...
		$('#form-create').submit(function(){
			$.ajax({
				url  : "{{route('kas_bank_kontroler.store')}}",
				type : "POST",

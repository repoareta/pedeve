        ...
        <div class="row">
            <table style="width:100%;" class="table">
                ...
                <tbody>
                    ...
                    @endforeach                   
                    <tr>
                        <td class="border-top-less" valign="top" style="height:{{ 560 - ($total_row*50) }}px">
                            <b><u>KETERANGAN :</u></b>
                            <br>
                            {{$ket1}}
                            <br>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td colspan="4" valign="top" style="border-top: 2px solid #FFFFFF; border-bottom: 2px solid #FFFFFF;">
                            ...
                            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
                            &nbsp;&nbsp;&nbsp;&nbsp;
                            Tgl. {{ Carbon\Carbon::parse($tgl_kurs)->format('d/m/Y') }}
                            <br>
                    ...
                    <tr>
                        <td class="text-center border-less">
                            <br>
                            <br>
                            {{ strtoupper($request->nminta1) }}
                        </td>
                        <td class="text-center border-less">
                            <br>
                            <br>
                            {{ strtoupper($request->nverifikasi1) }}
                        </td>
                        <td class="text-center border-less">
                            <br>
                            <br>
                            {{ strtoupper($request->nsetuju1) }}
                        </td>
                        <td class="text-center border-less">
                            <br>
                            <br>
                            {{ strtoupper($request->nbuku1) }}
                        </td>
                        <td colspan="4" class="text-center border-less">
                            <br>
                            <br>
                            {{ strtoupper($request->setuju2) }}
                        </td>
                    </tr>
                </tbody>
            </table>

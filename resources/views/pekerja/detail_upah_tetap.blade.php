<div class="kt-portlet__head" style="padding-left:0px; border-bottom: none;">
    <div class="kt-portlet__head-label">
        ...
        <div class="kt-portlet__head-actions" style="font-size: 2rem;">
            <span class="kt-font-success pointer-link" id="addRowUpahTetap" data-toggle="kt-tooltip" data-placement="top" title="Tambah Data">
                <i class="fas fa-plus-circle"></i>
            </span>

            <span class="kt-font-warning pointer-link" id="editRowUpahTetap" data-toggle="kt-tooltip" data-placement="top" title="Ubah Data">
                <i class="fas fa-edit"></i>
            </span>

            <span class="kt-font-danger pointer-link" id="deleteRowUpahTetap" data-toggle="kt-tooltip" data-placement="top" title="Hapus Data">
...
<table class="table table-striped table-bordered table-hover table-checkable" id="kt_table_upah_tetap">
...
<!--begin::Modal-->
<div class="modal fade" id="upahTetapModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
...
<script type="text/javascript">
	...
	var t = $('#kt_table_upah_tetap').DataTable({
		scrollX   : true,
		processing: true,
		serverSide: true,
		ajax: "{{ route('pekerja.upah_tetap.index.json', ['pekerja' => $pekerja->nopeg]) }}",
		columns: [
	...
	$('#addRowUpahTetap').click(function(e) {
		e.preventDefault();
		...
		if($(this).valid()) {
			...
			$.ajax({
				...
				success: function(dataResult){
					...
					// close modal
					$('#upahTetapModal').modal('toggle');
					// clear form
					$('#upahTetapModal').on('hidden.bs.modal', function () {
		...
		if($('input[name=radio_upah_tetap]').is(':checked')) { 
			$("input[name=radio_upah_tetap]:checked").each(function() {
				...
				.then((result) => {
					if (result.value) {
						$.ajax({
							url: "{{ route('pekerja.upah_tetap.delete') }}",
							type: 'DELETE',
							dataType: 'json',
							data: {
								"nopeg": nopeg,

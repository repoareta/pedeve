                            ...
                            <tr style="text-align:center;"  class="text-center">
                                <td >
                                    <table width="100%" style="text-align:center;">
                                        ...
                                        <tr >
                                            <td style="padding-top:3%;padding-bottom:2%;" width="25%">{{$request->minta1}}</td>
                                        </tr>
                                    </table>
                                </td>
                            </tr>                            
                            ...
                            <tr style="text-align:center;"  class="text-center">
                                <td >
                                    <table width="100%" style="text-align:center;">
                                        ...
                                        <tr >
                                            <td style="padding-top:3%;padding-bottom:2%;" width="25%">{{$request->verifikasi1}}</td>
                                        </tr>
                                    </table>
                                </td>
                            </tr>                            
                            ...
                            <tr style="text-align:center;"  class="text-center">
                                <td >
                                    <table width="100%" style="text-align:center;">
                                        ...
                                        <tr >
                                            <td style="padding-top:3%;padding-bottom:2%;" width="25%">{{$request->setuju1}}</td>
                                        </tr>
                                    </table>
                                </td>
                            </tr>                            
                            ...
                            <tr style="text-align:center;"  class="text-center">
                                <td >
                                    <table width="100%" style="text-align:center;">
                                        ...
                                        <tr >
                                            <td style="padding-top:3%;padding-bottom:2%;" width="25%">{{$request->buku1}}</td>
                                        </tr>
                                    </table>
                                </td>
                            </tr>                            

	...
	<div class="kt-container  kt-container--fluid ">
		<div class="kt-subheader__main">
			...
			<div class="kt-subheader__breadcrumbs">
				...
				<span class="kt-subheader__breadcrumbs-separator"></span>
				<span class="kt-subheader__breadcrumbs-link kt-subheader__breadcrumbs-link--active">Master Hutang</span>
			</div>
		</div>
	</div>
</div>
	...
	$(document).ready(function () {
		...
		var t = $('#kt_table').DataTable({
			...
			columns: [
				...
				{data: 'aard', name: 'aard'},
				{data: 'lastamount', name: 'lastamount'},
				{data: 'curramount', name: 'curramount', class:'no-wrap'}
			]
		});

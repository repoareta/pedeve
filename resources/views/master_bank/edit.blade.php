				...
				<div class="kt-portlet__body">
					<div class="form-group form-group-last">
						...
						<div class="form-group row">
							...
							<div class="col-10">
								<input class="form-control" name="nama" type="text" value="{{$nama}}" size="40" maxlength="50" onkeyup="this.value = this.value.toUpperCase()" required oninvalid="this.setCustomValidity('Nama Harus Diisi..')" oninput="setCustomValidity('')" autocomplete='off'>
							</div>
						</div>
						<div class="form-group row">
							<label class="col-2 col-form-label">Alamat<span style="color:red;">*</span></label>
							<div class="col-10">
								<input class="form-control" name="alamat" type="text" value="{{$alamat}}" size="40" maxlength="50" onkeyup="this.value = this.value.toUpperCase()" required oninvalid="this.setCustomValidity('Alamat Harus Diisi..')" oninput="setCustomValidity('')" autocomplete='off'>
							</div>
						</div>
						<div class="form-group row">
							<label class="col-2 col-form-label">Kota<span style="color:red;">*</span></label>
							<div class="col-10">
								<input class="form-control" name="kota" type="text" value="{{$kota}}" size="40" maxlength="50" onkeyup="this.value = this.value.toUpperCase()" required oninvalid="this.setCustomValidity('Kota Harus Diisi..')" oninput="setCustomValidity('')" autocomplete='off'>
							</div>
						</div>

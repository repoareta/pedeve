    ...
    <div id="kt_aside_menu" class="kt-aside-menu " data-ktmenu-vertical="1" data-ktmenu-scroll="1" data-ktmenu-dropdown-timeout="500">
        <ul class="kt-menu__nav ">
            ...
            @php
                ...
                $rencana_kerja = array(
                    'rencana_kerja.index',
                    'rencana_kerja.create',
                    'rencana_kerja.edit'                   
                ); // isi nama semua route rencana_kerja
                $pencapaian_kerja = array(
                    'pencapaian_kerja.index',
                    'pencapaian_kerja.search'                 
                ); // isi nama semua route pencapaian_kerja
            ...
            <li class="kt-menu__item  kt-menu__item--submenu {{ set_active($customer_management) }}" aria-haspopup="true" data-ktmenu-submenu-toggle="hover">
                ...
                <div class="kt-menu__submenu "><span class="kt-menu__arrow"></span>
                    <ul class="kt-menu__subnav">
                        ...
                        <li class="kt-menu__item kt-menu__item{{ set_active_submenu($rencana_kerja) }}" aria-haspopup="true">
                            <a href="{{route('rencana_kerja.index')}}" class="kt-menu__link">
                                <i class="kt-menu__link-bullet kt-menu__link-bullet--dot">
                                    <span></span>
                                </i>
                        ...
                        <li class="kt-menu__item kt-menu__item{{ set_active_submenu($pencapaian_kerja) }}" aria-haspopup="true">
                            <a href="{{route('pencapaian_kerja.index')}}" class="kt-menu__link">
                                <i class="kt-menu__link-bullet kt-menu__link-bullet--dot">
                                    <span></span>
                                </i>
                                <span class="kt-menu__link-text">Pencapaian Kinerja</span>
                            </a>
                        </li>
                        @endif
                        @endforeach

...
<html lang="en">
	...
	<body style="background-image: url('{{ asset('images/logo-login.png')}}');
				...
				class="kt-quick-panel--right kt-demo-panel--right kt-offcanvas-panel--right kt-header--fixed kt-header-mobile--fixed kt-subheader--enabled kt-subheader--fixed kt-subheader--solid kt-scrolltop--on"
				id="body-style">

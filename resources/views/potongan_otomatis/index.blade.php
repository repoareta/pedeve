...
<div class="kt-portlet kt-portlet--mobile">
	...
	<div class="kt-portlet__body">
			<form action="{{route('potongan_otomatis.search.index')}}" method="post">{{csrf_field()}}
				...
				Pegawai	<select style="font-family: sans-serif;font-weight:bold;width:20%;height:25px;border-radius:5px;" name="nopek" class="" data-live-search="true">
								<option value="">- Pilih -</option>
								@foreach($data_pegawai as $data)
									<option value="{{$data->nopeg}}"> {{$data->nama}}</option>
								@endforeach
							</select>
			Potongan	<select style="font-family: sans-serif;font-weight:bold;width:20%;height:25px;border-radius:5px;" name="aard" class="" data-live-search="true">
								<option value="">- Pilih -</option>
								@foreach($data_potongan as $dataa)
									<option value="{{$dataa->kode}}">{{$dataa->nama}}</option>
								@endforeach
							</select>
				Bulan:   <select style="font-family: sans-serif;font-weight:bold;width:-10%;height:25px;border-radius:5px;" name="bulan" id="bulan" class="" data-live-search="true">
							<option value="">- Pilih -</option>
			...
			Tahun: <input style="font-family: sans-serif;font-weight:bold;width:10%;height:25px;border-radius:5px;"  name="tahun"  type="text" size="4" maxlength="4" value="" onkeypress="return hanyaAngka(event)" autocomplete='off'>  

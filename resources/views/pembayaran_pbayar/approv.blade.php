	...
	<div class="kt-container  kt-container--fluid ">
		<div class="kt-subheader__main">
			<h3 class="kt-subheader__title">
				Pemabayaran Permintaan Bayar </h3>
			...
			<div class="kt-subheader__breadcrumbs">
				...
				<a href="" class="kt-subheader__breadcrumbs-link">
					Perbendaharaan </a>
				<span class="kt-subheader__breadcrumbs-separator"></span>
				<span class="kt-subheader__breadcrumbs-link kt-subheader__breadcrumbs-link--active">Pemabayaran Permintaan Bayar</span>
			</div>
		</div>
	</div>
</div>
...
<div class="kt-portlet kt-portlet--mobile">
	<div class="kt-portlet__head kt-portlet__head--lg">
		<div class="kt-portlet__head-label">
            ...
            @foreach($data_app as $data)
                @if($status == 'Y')
				Tabel <span style="color:blue;">Pembatalan</span> Approval Pemabayaran Permintaan Bayar
                @elseif($status == 'N')
				Tabel <span style="color:blue;">Eksekusi</span> Approval Pemabayaran Permintaan Bayar
                @endif
            @endforeach
			</h3>			
		</div>
	...
	<div class="kt-portlet__body">
        <form class="kt-form kt-form--label-right" action="{{ route('pembayaran_pbayar.store.app') }}" method="post">
            @csrf
            @foreach($data_app as $data)
            ...
            <div class="kt-form__actions">
                <div class="row">
                    <div class="col-2"></div>
                    <div class="col-10">
                        <a  href="{{ route('pembayaran_pbayar.index') }}" class="btn btn-warning"><i class="fa fa-reply" aria-hidden="true"></i> Batal</a>

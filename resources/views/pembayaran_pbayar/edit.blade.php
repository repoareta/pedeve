						...
						<div class="alert alert-secondary" role="alert">
							<div class="alert-text">
								<h5 class="kt-portlet__head-title">
									Header Menu Edit Pembayaran Permintaan Bayar
								</h5>	
							</div>
						</div>
...
$('#btn-delete-all').on('click', function(e) {
	e.preventDefault();
	$('#title-delete-detail').html("Hapus Detail Pembayaran Permintaan Bayar All");
...
$('#form-edit-detail').submit(function(){
	...
	$('#bulanbuku').datepicker({
		...
		var nilai = document.getElementById('nilai1');

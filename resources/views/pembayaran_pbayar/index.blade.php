		...
		<div class="kt-subheader__main">
			...
			<div class="kt-subheader__breadcrumbs">
				...
				<a href="" class="kt-subheader__breadcrumbs-link">
					Perbendaharaan </a>
				<span class="kt-subheader__breadcrumbs-separator"></span>
				<span class="kt-subheader__breadcrumbs-link kt-subheader__breadcrumbs-link--active">Pembayaran Permintaan Bayar</span>
			</div>
		</div>
	</div>
</div>
			...
			$('#editRow').click(function(e) {
				...
				if($('input[type=radio]').is(':checked')) { 
					$("input[type=radio]:checked").each(function(){
						...
						location.replace("{{url('perbendaharaan/pembayaran_pbayar/edit')}}"+ '/' +nodok);
					});
				} else {
					swalAlertInit('ubah');
				}
			...
			$('#exportRow').click(function(e) {
				...
				if($('input[class=btn-radio]').is(':checked')) { 
					$("input[class=btn-radio]:checked").each(function(){
						...
						location.replace("{{url('perbendaharaan/pembayaran_pbayar/rekap')}}"+ '/' +docno);
					});
				} else {
					swalAlertInit('cetak');
				}

		...
		<div class="kt-subheader__main">
			...
			<div class="kt-subheader__breadcrumbs">
				...
				<a href="" class="kt-subheader__breadcrumbs-link">
					Perbendaharaan </a>
				<span class="kt-subheader__breadcrumbs-separator"></span>
				<span class="kt-subheader__breadcrumbs-link kt-subheader__breadcrumbs-link--active">Cetak Pembayaran Permintaan Bayar</span>
			</div>
		</div>
	</div>
</div>
				...
				<div class="kt-form__actions">
					<div class="row">
						...
						<div class="col-10">
							...
							<a  href="{{url('perbendaharaan/pembayaran_pbayar/rekaprc')}}/{{$docs}}" class="btn btn-primary"><i class="fa fa-print" aria-hidden="true"></i>Cetak RC</a>
						</div>
					</div>
				</div>
			</div>

	...
	<div class="kt-container  kt-container--fluid ">
		<div class="kt-subheader__main">
			<h3 class="kt-subheader__title">
				Pembayaran Permintaan Bayar </h3>
						...
						<div class="alert alert-secondary" role="alert">
							<div class="alert-text">
								<h5 class="kt-portlet__head-title">
									Header Pembayaran Permintaan Bayar
								</h5>	
							</div>
						</div>
	...
	$.ajax({
		...
		if(data == 1){
			Swal.fire({
				...
				location.replace("{{url('perbendaharaan/pembayaran_pbayar/edit')}}"+ '/' +scurrdoc);
				});
		}else if(data = 2){
			Swal.fire({
				type  : 'info',

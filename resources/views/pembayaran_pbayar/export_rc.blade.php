...
<html>
    ...
    <body>
        ...
        <table width="100%">
            ...
            ?>
                ...
                <tr>
                    <td width="10%">No</td>
                    <td width="3%">:</td>
                    <td>RC  <font style="padding-left:5%;">/{{date('m')}}/PEDEVE/{{date('Y')}}</font></td>
                </tr>
                <tr>
        ...
        <table width="100%">
            ...
            <tr>
                <td style="text-align: justify;">Mohon bantuan Saudara agar dari rekening PT. Pertamina Pedeve Indonesia  No. {{$request->norek}} di Bank Saudara dapat dilaksanakan transfer/ Pemindahbukuan kepada : </td>
            </tr>
        </table>
        <table width="100%">
            <tr>
            ...
            <tr>
                ...
                <td>:</td>
                <td>{{number_format($request->jumangka,0) < 0 ? "(".number_format($request->jumangka*-1,2).")" : number_format($request->jumangka,2)}}</td>
            </tr>
            <tr>
        ...
        <table width="100%">
            ...
            <tr>
                <td colspan="3" style="padding-bottom:3%;">Atas perhatian dan kerjasama Saudara kami ucapkan terima kasih.</td>
            </tr>
        </table>
        <table width="100%">
            <tr>

	...
	<div class="kt-container  kt-container--fluid ">
		<div class="kt-subheader__main">
			...
			<div class="kt-subheader__breadcrumbs">
				...
				Kontroler </a>
				<span class="kt-subheader__breadcrumbs-separator"></span>
				<span class="kt-subheader__breadcrumbs-link kt-subheader__breadcrumbs-link--active">Master Perusahaan</span>
			</div>
		</div>
	</div>
</div>
			...
			<div class="kt-portlet__head-toolbar">
				<div class="kt-portlet__head-wrapper">
					<div class="kt-portlet__head-actions">
						<a href="{{ route('master_perusahaan.create') }}">
...
@section('scripts')
	...
	$('#kt_table').DataTable({
			...
			ajax      : "{{ route('master_perusahaan.index.json') }}",
			columns: [
	...
	$('#editRow').click(function(e) {
		...
		if($('input[class=btn-radio]').is(':checked')) { 
			$("input[class=btn-radio]:checked").each(function(){
				...
				location.replace("{{url('kontroler/master_perusahaan/edit')}}"+ '/' +kode);
			});
		} else {
			swalAlertInit('ubah');
		}
			...
			if($('input[class=btn-radio]').is(':checked')) { 
				$("input[class=btn-radio]:checked").each(function() {
					...
					const swalWithBootstrapButtons = Swal.mixin({
						...
						if (result.value) {
							$.ajax({
								url: "{{ route('master_perusahaan.delete') }}",
								type: 'DELETE',
								dataType: 'json',
								data: {
									"kode": kode,

		...
		<div class="kt-subheader__main">
			...
			<div class="kt-subheader__breadcrumbs">
				...
				<a href="" class="kt-subheader__breadcrumbs-link">
					Perbendaharaan </a>
				<span class="kt-subheader__breadcrumbs-separator"></span>
				<span class="kt-subheader__breadcrumbs-link kt-subheader__breadcrumbs-link--active">Cetak RC Penempatan Deposito</span>
			</div>
		</div>
	</div>
</div>
			...
			<div class="kt-portlet__body">
				<div class="form-group row">
					...
					<div class="col-8">
						...
						<input size="30" maxlength="30" type="hidden" value="{{$lineno}}" name="lineno" >
					</div>
				</div>
				<div class="form-group row">
					...
					<label class="col-2 col-form-label">No. Cek</label>
					<div class="col-3">
				...
				<div class="form-group row">
					...
					<div class="col-8">
						...
						<input size="30" maxlength="30" type="hidden" value="{{$tmt}}" name="tmt" >
					</div>
				</div>
				<div class="form-group row">
					...
					<div class="col-8">
						...
						<input size="30" maxlength="30" type="hidden" value="{{$bunga}}" name="bunga" >
					</div>
				</div>
				<div class="form-group row">
					...
					<div class="col-8">
						...
						<input size="30" maxlength="30" type="hidden" value="{{$jangka}}" name="jangka" >
					</div>
				</div>
				<div class="form-group row">

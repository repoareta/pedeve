		...
		<div class="kt-subheader__main">
			...
			<div class="kt-subheader__breadcrumbs">
				...
				<a href="" class="kt-subheader__breadcrumbs-link">
					SDM & Payroll </a>
				<span class="kt-subheader__breadcrumbs-separator"></span>
				<span class="kt-subheader__breadcrumbs-link kt-subheader__breadcrumbs-link--active">Perguruan Tinggi</span>
			</div>
		</div>
	</div>
</div>
	...
	<div class="kt-portlet__head kt-portlet__head--lg">
		<div class="kt-portlet__head-label">
			...
			<div class="kt-portlet__head-actions" style="font-size: 2rem;">
				<a href="{{ route('perguruan_tinggi.create') }}">
...
@section('scripts')
	...
	$(document).ready(function () {
		var t = $('#kt_table').DataTable({
			...
			processing: true,
			serverSide: true,
			ajax      : "{{ route('perguruan_tinggi.index.json') }}",
			columns: [
						...
						if (result.value) {
							$.ajax({
								...
								success: function () {
									Swal.fire({
										type  : 'success',
										title : 'Hapus Kode perguruan_tinggi: ' + id,
										text  : 'Berhasil',
										timer : 2000
									}).then(function() {
										t.ajax.reload();

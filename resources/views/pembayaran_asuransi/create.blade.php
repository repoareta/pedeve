		...
		<div class="kt-portlet__head kt-portlet__head--lg">
			<div class="kt-portlet__head-label">
				...
				<h3 class="kt-portlet__head-title">
					Tambah Kas/Bank Pencairan Asuransi
				</h3>			
			</div>
						...
						<div class="alert alert-secondary" role="alert">
							<div class="alert-text">
								<h5 class="kt-portlet__head-title">
									Header Kas/Bank Pencairan Asuransi
								</h5>	
							</div>
						</div>
...
$('#form-create').submit(function(){
	...
	$.ajax({
		url  : "{{route('pembayaran_asuransi.store')}}",
		type : "POST",
		...
		if(data == 1){
			Swal.fire({
				...
				location.replace("{{url('perbendaharaan/pembayaran_asuransi/edit')}}"+ '/' +scurrdoc);
				});
		}else if(data = 2){
			Swal.fire({
				type  : 'info',

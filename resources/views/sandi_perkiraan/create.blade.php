			...
			<form  class="kt-form kt-form--label-right" id="form-create">
				...
				<div class="kt-portlet__body">
					<div class="form-group form-group-last">
						...
						<div class="form-group row">
							<label for="" class="col-2 col-form-label">Nama Sanper<span style="color:red;">*</span></label>
							<div class="col-10">
						...
						<div class="kt-form__actions">
							<div class="row">
								<div class="col-2"></div>
								<div class="col-10">
									<a  href="{{route('sandi_perkiraan.index')}}" class="btn btn-warning"><i class="fa fa-reply" aria-hidden="true"></i>Cancel</a>
...
@section('scripts')
	...
	$(document).ready(function () {
		...
		$('#form-create').submit(function(){
			$.ajax({
				url  : "{{route('sandi_perkiraan.store')}}",
				type : "POST",
				...
				if(data == 1){
					Swal.fire({
						...
						window.location.replace("{{ route('sandi_perkiraan.index') }}");
						});
				}else{
					Swal.fire({
						type  : 'info',

                        ...
                        <table width="100%" style="border-collapse: collapse;" border="1">
                            ...
                            <tr style="font-size: 7pt;">
                                ...
                                $subtotala[$b] = $b;
                                 ...
                                 $subtotala6[$b] = $b6;
                                 $subtotala7[$b] = $b7;
                                 $subtotala8[$b] = $pot_pajak;
                                 $subtotala9[$b] = $iuranjm;
                                 $subtotala10[$b] = $pembulatan;
                                 $subtotala11[$b] = $gajihbersih;
                                 $subtotala12[$b] = $total;
                                ?>
                                <td style="text-align:right;">{{number_format($total,0)}}</td>
                                <td style="text-align:right;">{{$data->pot_pajak <= 0 ? '('.number_format($data->pot_pajak*-1,0).')' : number_format($data->pot_pajak,0)}}</td>
                            ...
                            @endforeach<tr style="font-size: 7pt;font-weight: bold">
                                <td colspan="3" style="text-align:right;">SUB TOTAL</td>
                                <td style="text-align:right;">{{number_format(array_sum($subtotala),0)}}</td>
                                <td style="text-align:right;">{{number_format(array_sum($subtotala1),0)}}</td>
                                <td style="text-align:right;">{{number_format(array_sum($subtotala2),0)}}</td>
                            ...
                            <tr style="font-size: 7pt;">
                                ...
                                $subtotala[$c] = $c;
                                 ...
                                 $subtotala6[$c] = $c6;
                                 $subtotala7[$c] = $c7;
                                 $subtotala8[$c] = $pot_pajak;
                                 $subtotala9[$c] = $iuranjm;
                                 $subtotala10[$c] = $pembulatan;
                                 $subtotala11[$c] = $gajihbersih;
                                 $subtotala12[$c] = $total;
                                ?>
                                <td style="text-align:right;">{{number_format($total,0)}}</td>
                                <td style="text-align:right;">{{$data->pot_pajak <= 0 ? '('.number_format($data->pot_pajak*-1,0).')' : number_format($data->pot_pajak,0)}}</td>

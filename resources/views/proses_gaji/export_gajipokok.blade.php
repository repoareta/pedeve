    ...
    <body>
        ...
        <header>
                ...
                <tr>
                    <td align="left" style="padding-left:80px;">
                        <table>
                            ...
                            <tr>
                                <td><font style="font-size: 12pt;font-weight: bold ">REKAP DATA GAJI POKOK</font></td>
                            </tr>
                            <tr>
                                <td><font style="font-size: 12pt;font-weight: bold ">TAHUN 2020</font></td>
                            </tr>
                        </table>
                    </td>
            ...
            <table width="100%"  style="padding-top:6%; padding-left:30px;;padding-right:30px;">
                <tr>
                    <td>
                        <font style="font-size: 10pt;font-style: italic">Tanggal Cetak:</font>
                    </td>
                </tr>
                <tr>
                    <td>

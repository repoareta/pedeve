		...
		<div class="kt-subheader__main">
			...
			<div class="kt-subheader__breadcrumbs">
				...
				<a href="" class="kt-subheader__breadcrumbs-link">
					Perbendaharaan </a>
				<span class="kt-subheader__breadcrumbs-separator"></span>
				<span class="kt-subheader__breadcrumbs-link kt-subheader__breadcrumbs-link--active">Inisialisasi Saldo</span>
			</div>
		</div>
	</div>
</div>
	...
	<div class="kt-portlet__head kt-portlet__head--lg">
		<div class="kt-portlet__head-label">
			...
			<h3 class="kt-portlet__head-title">
				Tabel Inisialisasi Saldo
			</h3>			
			<div class="kt-portlet__head-toolbar">
				<div class="kt-portlet__head-wrapper">
					<div class="kt-portlet__head-actions">
						<a href="{{ route('inisialisasi_saldo.create') }}">
...
$(document).ready(function () {
	$('#kt_table').DataTable({
			...
			ajax      : "{{ route('inisialisasi_saldo.index.json') }}",
			columns: [
				...
				{data: 'inputdate', name: 'inputdate'},
			]
	});

	//edit inisialisasi saldo
	$('#editRow').click(function(e) {
			...
			if($('input[class=btn-radio]').is(':checked')) { 
				$("input[class=btn-radio]:checked").each(function(){
					...
					location.replace("{{url('perbendaharaan/inisialisasi_saldo/edit')}}"+ '/' +jk+'/'+nokas);
				});
			} else {
				swalAlertInit('ubah');
			}
				...
				$("input[class=btn-radio]:checked").each(function() {
					...
					const swalWithBootstrapButtons = Swal.mixin({
						...
						swalWithBootstrapButtons.fire({
							...
							text: "Nokas : " + nokas+ " Dan No Jenis Kartu : "+jk,
							type: 'warning',
						...
						if (result.value) {
							$.ajax({
								url: "{{ route('inisialisasi_saldo.delete') }}",
								type: 'DELETE',
								dataType: 'json',
								data: {
									"jk": jk,
								...
								success: function () {
									Swal.fire({
										type  : 'success',
										title : "Nokas : " + nokas+ " Dan No Jenis Kartu : "+jk,
										text  : 'Berhasil',
										timer : 2000
									}).then(function() {
										location.reload();

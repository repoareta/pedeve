                        ...
                        <table width="100%" style="border-collapse: collapse; " border="1">
                            ...
                            <tr style="font-size: 10pt;">
                                ...
                                <?php
                                   ...
                                   $subtotala3[$a] = $bruto;
                                ?>
                                <td style="text-align:right;">{{number_format($data->ut,2,'.',',')}}</td>
                                <td style="text-align:right;">{{number_format($data->nilai,2,'.',',')}}</td>
                                <td style="text-align:right;">{{number_format($data->pajakins,2,'.',',')}}</td>
                            ...
                            <tr style="font-size: 10pt;font-weight: bold">
                                ...
                                <td style="text-align:right;">{{number_format(array_sum($subtotala2),2,'.',',')}}</td>              
                            ...
                            <tr style="font-size: 10pt;font-weight: bold">
                                ...
                                <td style="text-align:right;">{{number_format(array_sum($subtotalb2),2,'.',',')}}</td>              
                            ...
                            <tr style="font-size: 10pt;font-weight: bold">
                                ...
                                <td style="text-align:right;">{{number_format($suba3,2,'.',',')}}</td>             

...
class PekerjaStore extends FormRequest
{
    ...
    public function rules()
    {
        return [
            ...
            'alamat_2'            => "different:alamat_1|different:alamat_3|required_with:alamat_3",
            'alamat_3'            => "different:alamat_1|different:alamat_2",
            'gelar_1'             => "required|different:gelar_2|different:gelar_3",
            'gelar_2'             => "different:gelar_1|different:gelar_3|required_with:gelar_3",
            'gelar_3'             => "different:gelar_1|different:gelar_2",
            'no_handphone'        => "required|numeric|digits_between:10,15",
            'jenis_kelamin'       => "required",
            'npwp'                => "numeric|digits_between:10,20",
            'photo'               => "image",
        ];
    }
}

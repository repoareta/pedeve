...
class PembayaranJumkController extends Controller
{
    public function index()
    {
        ...
        return view('pembayaran_jumk.index',compact('tahun','bulan'));
    }
    ...
    public function rekap($docs)
    {
        ...
        return view('pembayaran_jumk.rekap',compact(
            'docs',
            'minta1',
            'nminta1',
            'verifikasi1',
    ...
    public function export(Request $request)
    {
        ...
        if(!empty($data_list)){
            ...
            $pdf = DomPDF::loadview("pembayaran_jumk.$reportname",compact(
                'request',
                'data_list',
                'jk',
                'bulan',
    ...
    public function rekapRc($docno)
    {
        ...
        if(!empty($data_list)){
            ...
            return view('pembayaran_jumk.rekap_rc',compact(
                'docno',
                'lampiran',
                'perihal',
                'norek',
    ...
    {
            $pdf = DomPDF::loadview('pembayaran_jumk.export_rc',compact('request'))->setPaper('A4', 'Portrait');
            $pdf->output();
            $dom_pdf = $pdf->getDomPDF();

...
class OpeningBalanceController extends Controller
{
    ...
    {
        return view('opening_balance.index');
    }
    ...
    public function searchIndex(Request $request)
    {
        ...
        ->addColumn('radio', function ($data) {
            $radio = '<center><label class="kt-radio kt-radio--bold kt-radio--brand"><input type="radio" kode="'.$data->thnblnsup.'" class="btn-radio" name="btn-radio"><span></span></label></center>'; 
            return $radio;
        })
        ->rawColumns(['radio'])
        ->make(true); 
    ...
    {
        return view('opening_balance.create');
    }
    ...
    {
        $data = DB::select("select substr(thnblnsup,1,4) tahun from history_ob where thnblnsup='$no'");
        foreach($data as $dat)
        {
            $tahun = $dat->tahun;        }
        return view('opening_balance.edit',compact('tahun'));
    }

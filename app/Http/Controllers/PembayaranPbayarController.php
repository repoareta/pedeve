...
class PembayaranPbayarController extends Controller
{
    public function index()
    {
        ...
        return view('pembayaran_pbayar.index',compact('tahun','bulan'));
    }
    ...
    public function rekap($docs)
    {
        ...
        return view('pembayaran_pbayar.rekap',compact(
            'docs',
            'minta1',
            'nminta1',
            'verifikasi1',
    ...
    public function rekapRc($docno)
    {
        ...
        if(!empty($data_list)){
            ...
            return view('pembayaran_pbayar.rekap_rc',compact(
                'docno',
                'lampiran',
                'perihal',
                'norek',
    ...
    {
            $pdf = DomPDF::loadview('pembayaran_pbayar.export_rc',compact('request'))->setPaper('A4', 'Portrait');
            $pdf->output();
            $dom_pdf = $pdf->getDomPDF();

...
class PotonganOtomatisController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('potongan_otomatis.index',compact('data_list','data_pegawai','data_potongan'));
    }
